...
@app.route('/')
def hello_world():
  with urllib.request.urlopen('https://hello-world-1-service-chloesheasby.cloud.okteto.net/tap1') as res:
...
@app.route('/tap2')
def tap2():
  return "You have reached hello-world-2! My host name is " + socket.gethostname()
...
if __name__ == '__main__':
  print('Starting hello-world-2 server...')
